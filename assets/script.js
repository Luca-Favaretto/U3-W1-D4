...
var urlDario = "https://61fb890c87801d0017a2c55c.mockapi.io/v1/metadata";
...
fetch(url)
    ...
    array.forEach(function (element) {
        var id = element.id, codprod = element.codprod, collezione = element.collezione, capo = element.capo, modello = element.modello, quantita = element.quantita, colore = element.colore, prezzoivaesclusa = element.prezzoivaesclusa, prezzoivainclusa = element.prezzoivainclusa, disponibile = element.disponibile, saldo = element.saldo;
        var articolo = new Articolo(id, codprod, collezione, capo, modello, quantita, colore, prezzoivaesclusa, prezzoivainclusa, disponibile, saldo);
